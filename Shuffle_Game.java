...
public class Shuffle_Game1 extends JPanel { // our grid will be drawn in a dedicated Panel
    ...
    public Shuffle_Game1(int size, int dim, int mar) {
        this.size=size;
        dimension = dim;
        margin = mar;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            String box = (String) JOptionPane.showInputDialog(null,"Plzz Enter value");
            n = Integer.parseInt(box);
            frame.add(new Shuffle_Game1(n, 600, 20), BorderLayout.CENTER);
            frame.pack();
